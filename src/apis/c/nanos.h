...
NANOS_API_DECL(nanos_err_t, nanos_team_get_num_supporting_threads_FIXME, ( int *n ) );
NANOS_API_DECL(nanos_err_t, nanos_team_get_supporting_threads_FIXME, ( int *n, nanos_thread_t *list_of_threads) );
