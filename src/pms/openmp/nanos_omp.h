...
NANOS_API_DECL(void, nanos_omp_set_process_mask,( const nanos_cpu_set_t cpu_set ));
...
NANOS_API_DECL(void, nanos_omp_set_active_mask,( const nanos_cpu_set_t cpu_set ));
