...
namespace nanos {
   ...
   class NetworkAPI
   {
      public:
         ...
         virtual void put ( unsigned int remoteNode, uint64_t remoteAddr, void *localAddr, size_t size, unsigned int wdId ) = 0;
         ...
         virtual void sendRequestPut( unsigned int dest, uint64_t origAddr, unsigned int dataDest, uint64_t dstAddr, size_t len, unsigned int wdId ) = 0;
