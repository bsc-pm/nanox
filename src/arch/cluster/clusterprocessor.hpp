...
#ifndef _NANOS_CLUSTER_PROCESSOR
#define _NANOS_CLUSTER_PROCESSOR
...
namespace ext
{
   ...
   class ClusterProcessor : public Accelerator
   {
      ...
      private:
         ...
         ClusterProcessor( const ClusterProcessor &pe );
         const ClusterProcessor & operator= ( const ClusterProcessor &pe );

         //Cache<ClusterDevice> _cache;

      public:
         void start_gasnet(void);
         // constructors
         ClusterProcessor( int id ) : Accelerator( id, &Cluster ) { }
