...
SMPProcessor::SMPProcessor( int bindingId, memory_space_id_t numaMemId, bool active ) : PE( &SMP, NULL, numaMemId ), _bindingId( bindingId ), _reserved(false), _active( active ) {}
