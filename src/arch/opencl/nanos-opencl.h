...
//TODO: ADD
    ...
    //nanos_opencl_set_bufferarg(void* opencl_kernel, arg_num, void* pointer);
    //nanos_opencl_set_arg(void* opencl_kernel, arg_num, size_t data_size, void* pointer);
    //nanos_exec_kernel(void* opencl_kernel, int work_dim, size_t* ndr_offset, size_t* ndr_local_size, size_t* ndr_global_size);
NANOS_API_DECL(void*, nanos_create_current_kernel, (char* kernel_name, char* opencl_code, char* compiler_opts));
