...
NANOS_API_DECL(nanos_err_t,nanos_profile_exec_kernel, (void* opencl_kernel, int work_dim, int range_size, size_t* ndr_offset, size_t* ndr_local_size, size_t* ndr_global_size));
