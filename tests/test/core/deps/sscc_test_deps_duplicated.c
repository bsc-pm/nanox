    ...
    {
        {
            ...
            int *__tmp_1 = &b;
            {
                ...
                else
                {
                    ...
                    err = nanos_create_wd_and_run_compact(&const_data_1.base, &dyn_props, sizeof(_nx_data_env_0_t), &imm_args, 2, (nanos_dependence_t *) _dependences, 0, (nanos_copy_data_t *) 0);
