...
nanos_const_wd_definition_t const_data4 = 
{
   {
      .mandatory_creation = true,
      .tied = false,
...
nanos_const_wd_definition_t const_data5 = 
{
   {
      .mandatory_creation = true,
      .tied = false,
...
nanos_const_wd_definition_t const_data6 = 
{
   {
      .mandatory_creation = true,
      .tied = false,
...
nanos_const_wd_definition_t const_data7 = 
{
   {
      .mandatory_creation = true,
      .tied = false,
...
nanos_const_wd_definition_t const_data8 = 
{
   {
      .mandatory_creation = true,
      .tied = false,
...
bool multiple_predecessors()
{
   ...
   NANOS_SAFE( nanos_create_wd_compact ( &wd2, &const_data3, sizeof( my_args ), ( void ** )&args2, nanos_current_wd(), NULL ) );
   for ( j = 0; j < size; j++)
...
bool out_dep_chain()
{
   ...
   const_data4.devices[0].dd_size = nanos_smp_dd_size;
   const_data4.data_alignment = __alignof__(my_args);
   NANOS_SAFE( nanos_create_wd_compact ( &wd1, &const_data4, sizeof( my_args ), ( void ** )&args1, nanos_current_wd(), NULL ) );
