...
static void nanos_xlate_fun_kkc_0(struct nanos_args_0_t *const arg, void *wd)
{
  {
...
int main(int argc, char **argv)
{
  ...
  {
    {
      int mcc_ndrange_2_0 = 10;
      unsigned int mcc_ndrange_2_1 = workgroup_size;
      int mcc_arg_0 = 10;
      int *mcc_arg_1 = x;
      {
        ...
        static struct nanos_const_wd_definition_1 nanos_wd_const_data = {.base = {.props = {.mandatory_creation = 1, .tied = 0, .clear_chunk = 0, .reserved0 = 0, .reserved1 = 0, .reserved2 = 0, .reserved3 = 0, .reserved4 = 0}, .data_alignment = __alignof__(struct nanos_args_0_t), .num_copies = 1, .num_devices = 1, .num_dimensions = 1, .description = "init"}, .devices = {[0] = {.factory = &nanos_opencl_factory, .arg = &ocl_ol_init_1_args}}};
        ...
        dimensions_0[0].size = sizeof(int) * (((mcc_arg_0 - 1) - (0L) - 0L) + 1L);
        dimensions_0[0].lower_bound = sizeof(int) * (0L - 0L);
        dimensions_0[0].accessed_length = sizeof(int) * ((mcc_arg_0 - 1 - 0L) + 1L);
        dependences[0].address = (void *)mcc_arg_1;
        dependences[0].offset = 4L * (((0L) - (0L)));
        ...
        if (nanos_wd_ != (void *)0)
          {
            ...
            ol_copy_dimensions[0 + 0].size = (((mcc_arg_0 - 1) - (0L) - 0L) + 1L) * sizeof(int);
            ol_copy_dimensions[0 + 0].lower_bound = (0L - 0L) * sizeof(int);
            ol_copy_dimensions[0 + 0].accessed_length = (mcc_arg_0 - 1 - 0L - (0L - 0L) + 1) * sizeof(int);
            ...
            ol_copy_data[0].offset = 4L * (((0L) - (0L)));
            nanos_err = nanos_set_translate_function(nanos_wd_, (void (*)(void *, nanos_wd_t))nanos_xlate_fun_kkc_0);
            if (nanos_err != NANOS_OK)
              {
                nanos_handle_error(nanos_err);
              }
        ...
        else
          {
            ...
            imm_copy_dimensions[0 + 0].size = (((mcc_arg_0 - 1) - (0L) - 0L) + 1L) * sizeof(int);
            imm_copy_dimensions[0 + 0].lower_bound = (0L - 0L) * sizeof(int);
            imm_copy_dimensions[0 + 0].accessed_length = (mcc_arg_0 - 1 - 0L - (0L - 0L) + 1) * sizeof(int);
            ...
            imm_copy_data[0].offset = 4L * (((0L) - (0L)));
            nanos_err = nanos_create_wd_and_run_compact(&nanos_wd_const_data.base, &nanos_wd_dyn_props, sizeof(struct nanos_args_0_t), &imm_args, 1, &dependences[0], imm_copy_data, imm_copy_dimensions, (void (*)(void *, nanos_wd_t))nanos_xlate_fun_kkc_0);
            if (nanos_err != NANOS_OK)
              {
                nanos_handle_error(nanos_err);
              }
...
static void ocl_ol_init_1_unpacked(int n, int *x, int mcc_ndrange_2_0, unsigned int mcc_ndrange_2_1)
{
  {
    nanos_err_t nanos_err;
    ...
    local_size_zero = 1;
    offset_arr[0] = 0;
    local_size_arr[0] = mcc_ndrange_2_1;
    global_size_arr[0] = mcc_ndrange_2_0;
    nanos_err = nanos_exec_profile_kernel(ompss_kernel_ocl, num_dim, offset_arr, local_size_arr, global_size_arr);
  }
}
static void ocl_ol_init_1(struct nanos_args_0_t *const args)
{
  {
    ocl_ol_init_1_unpacked((*args).n, (*args).x, (*args).mcc_ndrange_2_0, (*args).mcc_ndrange_2_1);
  }
}
