...
scheduling_small=['--schedule=bf','--schedule=dbf']
#scheduling_small=['--schedule=wf','--schedule=cilk']

scheduling_full=['--schedule=bf --bf-stack','--schedule=bf --no-bf-stack','--schedule=dbf']
