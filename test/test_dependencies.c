...
int main ( int argc, char **argv )
{
   ...
   NANOS_SAFE( nanos_create_wd ( &wd1, 1,test_devices_1, 0, (void*)&dummy, nanos_current_wd(), &props, 0, &cd) );
   NANOS_SAFE( nanos_submit( wd1,1,&deps,0 ) );


   nanos_wd_t wd2=0;
   nanos_device_t test_devices_2[1] = { NANOS_SMP_DESC( test_device_arg_2) };
   NANOS_SAFE( nanos_create_wd ( &wd2, 1,test_devices_2, 0, (void*)&dummy, nanos_current_wd(), &props, 0, &cd) );
